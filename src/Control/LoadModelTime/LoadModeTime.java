...
import Control.LoadModelTime.SubModeTime.DateVnMode;
import Control.LoadModelTime.SubModeTime.TimeCustomerMode;
import Control.LoadModelTime.SubModeTime.TimeVnMode;
...
public class LoadModeTime {
    ...
    public LoadModeTime() {
        ...
        addColor();
        addTimeMode();
        this.timer = new Timer(999, (ActionEvent e) -> {
