...
public final class AllKeyWord {
    ...
    public static class SFIS {
        ...
        public static final String ERRORDES = "errorDes";
    ...
    public static class CONFIG {
        ...
        public static final String LOOP_TEST = "loop";
    ...
    public static final String CHANGE_FUNC = "change_mode_func";
    public static final String NAME_APP = "name_app";
    public static final String LOCAL_LOG = "local_dir_log";
